...
void NodeGraph::init_test_node_graph(const PipelineManager& manager, WGPUDevice device)
{
    ...
    connect_sockets(hash_map_node, CreateHashMapNode::Output::TILE_ID_TO_TEXTURE_ARRAY_INDEX_MAP, normal_compute_node,
        NormalComputeNode::Input::TILE_ID_TO_TEXTURE_ARRAY_INDEX_MAP);
    connect_sockets(hash_map_node, CreateHashMapNode::Output::TEXTURE_ARRAY, normal_compute_node, NormalComputeNode::Input::TEXTURE_ARRAY);
    ...
    connect_sockets(normal_compute_node, NormalComputeNode::Output::OUTPUT_TEXTURE_ARRAY, downsample_tiles_node, DownsampleComputeNode::Input::TEXTURE_ARRAY);
