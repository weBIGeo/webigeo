...
void ComputeNormalsNode::run_impl()
{
    ...
    std::vector<WGPUBindGroupEntry> entries {
        ...
        hash_map.key_buffer().create_bind_group_entry(2),
        hash_map.value_buffer().create_bind_group_entry(3),
        height_textures.texture().texture_view().create_bind_group_entry(4),
        height_textures.texture().sampler().create_bind_group_entry(5),
        m_output_texture.texture().texture_view().create_bind_group_entry(6),
    };
