...
public:
    ...
    const webgpu::raii::CombinedComputePipeline& tonemap_compute_pipeline() const;
    ...
    const webgpu::raii::BindGroupLayout& tonemap_bind_group_layout() const;
...
private:
    ...
    void create_tonemap_compute_pipeline();
    ...
    void create_tonemap_bind_group_layout();
...
private:
    ...
    std::unique_ptr<webgpu::raii::CombinedComputePipeline> m_tonemap_compute_pipeline;
    ...
    std::unique_ptr<webgpu::raii::BindGroupLayout> m_tonemap_bind_group_layout;
