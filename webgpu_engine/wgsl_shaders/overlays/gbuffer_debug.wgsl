...
// Displays the debug data that render_tiles.wgsl packs into GBuffer slot 3 (the "overlay"
// attachment) based on shared_config.overlay_mode. This overlay does not pick the mode itself;
// it only unpacks slot 3 and composites it onto the overlay output texture.
