...
public:
    static std::unique_ptr<SkyAtmosphereLutRenderer> create(
...
private:
    ...
    std::unique_ptr<sky::util::ComputePass> m_transmittance_lut_pass;
    std::unique_ptr<sky::util::ComputePass> m_multi_scattering_lut_pass;
    std::unique_ptr<sky::util::ComputePass> m_sky_view_lut_pass;
    std::unique_ptr<sky::util::ComputePass> m_aerial_perspective_lut_pass;
};
