    ...
    , m_lut_sampler { util::makeLutSampler(device) }
{
    ...
    transmittanceLutDescriptor.label = WGPUStringView { .data = "transmittance LUT", .length = WGPU_STRLEN };
    ...
    multiScatteringLutDescriptor.label = WGPUStringView { .data = "multi scattering LUT", .length = WGPU_STRLEN };
    ...
    skyViewLutDescriptor.label = WGPUStringView { .data = "sky view LUT", .length = WGPU_STRLEN };
