...
@group(2) @binding(1) var cloud_shadow_texture: texture_2d<f32>;
@group(2) @binding(2) var cloud_shadow_sampler: sampler;
@group(2) @binding(3) var depth_texture: texture_2d<f32>;
